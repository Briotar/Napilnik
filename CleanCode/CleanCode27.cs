private void checkButton_Click(object sender, EventArgs e)
{
    ...
    else
    {
        ...
        else
        {
            ...
            TryConnectDatabase(commandText, connectionString);
        }
    }
}

private void TryConnectDatabase(string commandText, string connectionString)
{
    try
    {
        SQLiteConnection connection = new SQLiteConnection(connectionString);
        SQLiteDataAdapter sqLiteDataAdapter = new SQLiteDataAdapter(new SQLiteCommand(commandText, connection));
        connection.Open(sqLiteDataAdapter);

        TryFindInData(sqLiteDataAdapter);
...
private void TryFindInData(SQLiteDataAdapter sqLiteDataAdapter)
{
